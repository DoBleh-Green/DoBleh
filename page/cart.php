...
<body>
  ...
  if (isset($_SESSION['id_user'])) {
    ...
    // Lakukan kueri SQL untuk memeriksa apakah id_user ada di tabel transaksi
    $sql_check_user = "SELECT * FROM transaksi WHERE id_user = $id_user";
    ...
    if (mysqli_num_rows($query_check_user) > 0) {
      // Jika id_user ada dalam tabel transaksi, tampilkan pesan "Anda memesan"
      echo "<div class='b-t' ><div class='bg'><h1 class='th1' >Anda sedang memesan, <br> silakan menyelesaikan pesanan anda terlebih dahulu</h1></div></div>";
    } else {
      ...
      if (mysqli_num_rows($query2) > 0) {
        ...
        echo "<a class='btn-checkout' onclick='validatePenerima()' href='checkOut.php'>Check Out</a>";
        echo "</div>";
...
<script src="../script/chck.js"></script>
